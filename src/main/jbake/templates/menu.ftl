    ...
    <div class="container">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="/">
                    <img alt="Brand" src="img/yangdb-LOGO-navbar.jpg" class="img-responsive" width="100px" style="position: relative; top: -3px;">
            </a>
        </div>
            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a href="https://github.com/YANG-DB/yang-db/issues">Issue tracker</a></li>
                        <li><a href="/powered-by.html">Powered by YangDb </a></li>
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a href="/knowledge-ontology.html">Knowledge</a></li>
                        <li><a href="/custom-ontology.html">Custonm</a></li>
